        ...
        <div class="row">
            ...
            <div class="col-6" id="form">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p class="text-center my-3">Already Registered <a href="index.php">Login Here</a></p>
                    <p class="text-center my-3">forgot password <a href="password-recovery-mail.php">Click Here to recover</a></p>
                </form>
            </div>
        </div>
    </div>
