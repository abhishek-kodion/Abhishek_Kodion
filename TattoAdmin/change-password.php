...
<body>
  ...
  <div class="container">
    <div class="row my-3">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-danger" type="button" onclick="myFunction1()"><i class="fa fa-eye" aria-hidden="true"></i></button>
              </div>
            </div>
            <div class="row">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-danger" type="button" onclick="myFunction2()"><i class="fa fa-eye" aria-hidden="true"></i></button>
              </div>
            </div>
            <div class="row">
      ...
      <div class="col-6">
        <img src="https://img.freepik.com/free-vector/my-password-concept-illustration_114360-3864.jpg?w=740&t=st=1688733816~exp=1688734416~hmac=04531f4e3b41a4d098ba090ce1c3e8e4c7377eac52e0a81cbbe2ea7271677dca" alt="">
      </div>
    </div>
  </div>
