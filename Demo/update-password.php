    ...
    <div class="row my-3">
        <div class="col-6" style="margin-top: 165px;">
           <h3 class="text-center">Change Your Password</h3>
            ...
            <input type="password" class="form-control" id="myInput" required name="current_password"  aria-label="Example select with button addon" placeholder="old password here" maxlength="10"> 
            ...
            <div class="input-group">
            <input type="password" class="form-control" name="new_password" required id="myInput1" aria-label="Example select with button addon" placeholder="New password here" maxlength="10">
            <div class="input-group-append">
            ...
            <div class="input-group">
            <input type="password" class="form-control" name="confirm_password" required id="myInput2" aria-label="Example select with button addon" placeholder=" Confirm New password here" maxlength="10">
            <div class="input-group-append">
