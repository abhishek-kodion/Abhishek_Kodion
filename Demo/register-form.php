...
<body>
    <div class="container my-5">
        ...
        <span class="error"><?php echo $passwordErr; ?></span>
            ...
            <input type="password" class="form-control" name="password" id="myInput1" required  maxlength="32" minlength="10">
            ...
            <div class="input-group">
            <input type="password" class="form-control" name="cpassword" id="myInput2"  required maxlength="32" minlength="10">
            <div class="input-group-append">
